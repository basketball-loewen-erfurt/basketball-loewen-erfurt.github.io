...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* Rücklink links, Newsletter-Link rechts — "Original ansehen" sitzt stattdessen
     oben im Text-Grid, bündig mit der Bildoberkante (siehe contentEl.innerHTML unten).
     permalink ist nur bei echten Posts vorhanden. */
  ...
  fetch(feedConfig.url, { cache: 'no-cache' })
    ...
    .then(function (data) {
      ...
      var instaLink = post.permalink
        ? '<a class="btn btn-outline-orange btn-sm" style="margin-bottom:16px" href="' + post.permalink + '" target="_blank" rel="noopener">' + INSTAGRAM_ICON + ' Original ansehen</a>'
        : '';
